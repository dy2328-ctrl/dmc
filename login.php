...
<head>
    ...
    <style>
        body { 
            ...
            background: #020202; 
            background-image: radial-gradient(circle at 50% -20%, #1e1b4b, #000000 60%);
        ...
        .glass-box { 
            ...
            width: 400px; padding: 60px 40px; border-radius: 30px; 
            text-align: center; 
        ...
        h2 { font-weight: 800; margin: 0 0 10px; letter-spacing: 1px; }
        ...
        button { 
            ...
            color: white; font-weight: 800; cursor: pointer; font-size: 16px; 
            transition: 0.3s; 
        }
...
<body>
    <div class="glass-box">
        <div class="logo-circle"><img src="logo.png" style="max-width:70%; max-height:70%"></div>
        <h2><?= $name ?></h2>
        <p>نظام إدارة الأملاك المتطور</p>
